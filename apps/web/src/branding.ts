...
// Second Brain fork: the web/browser surface is branded "Second Brain" (plain,
// no stage suffix in production). Desktop builds keep whatever the shell
// injects, so upstream packaging is unaffected.
export const APP_BASE_NAME = injectedDesktopAppBranding?.baseName ?? "Second Brain";
